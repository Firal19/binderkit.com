...
export const PRODUCTS = [
  ...
  },
  {
    ...
    handle: 'careshopapp',
    cta: { primary: 'Start free', secondary: 'See the buy queue', trial: false },
    tabs: ['Today', 'Stock', 'Buy', 'Cook', 'More'],
    nav: [{ group: 'The kitchen', items: ['Today', 'Stock', 'Buy queue', 'Shopping', 'Menu', 'Compliance'] }, { group: 'Organisation', items: ['Houses', 'Residents', 'Reserves', 'Analytics', 'Settings'] }],
    firstTen: ['Add a zone and scan five items from the pantry.', 'Set a par on one and watch it become a buy request.', 'Add a resident with a tree-nut allergy and see the menu warn.', 'Open Compliance and see the reserve target computed from the bed count and the quantity per bed per day.'],
    proof: ['Live at careshop.app and used by real houses; a caregiver scans groceries into it at the store today.', 'Ten Oregon citations are explained in the product today and every other catalogue row carries the bare rule text; the confidence on each citation, and the banner on a rule set no provider has reviewed, are what the rebuild adds.', 'Residents stay a label, never a name: diet tags, allergens, one texture level.'],
    ...
    pricing: { unit: 'house', rows: [['Free', '$0', 'One house, three users, five hundred items — retired in the specification, still sold'], ['Pro', '$19 / mo', 'The live price, carried as the anchor; five houses in the live quota'], ['Scale', '$37 / mo', 'Unlimited houses, cross-house spend, catalogue import and copying between houses']], note: 'The live ladder. Confirming $19 and $37 as shipped prices rather than anchors is open, and so is the house allowance on Pro — the family line says up to three, the live quota is five. The three-day trial is the family standard and is not in the code.' },
  },
  {
