...
export const PRODUCTS = [
  ...
  },
  {
    ...
    status: 'Draft v2.1 · pilot in Eugene', statusKind: 'pilot',
    ...
    proof: ['Runs at an AFH-DD pilot home in Eugene; the exit criterion is fourteen consecutive days of medication passes without paper.', 'Two physical-harm gates — a medication that matches a recorded allergy, an as-needed dose given too soon — and nothing else that blocks.', 'Append-only: corrections are addenda under the original; nothing is deleted.'],
    ...
    pricing: { unit: 'house', rows: [['3-day trial', 'Card on file', 'Everything Pro shows; one-tap cancel'], ['Pro', 'Open (#8)', 'AFH operator, up to 3 houses'], ['Scale', 'Open (#8)', 'Agency or multi-home: roll-ups, agency roles, exports']], note: 'Prices are open item #8. The prior $10 per house may survive as the metered add-on.' },
  },
  {
    ...
    status: 'Live · rebuild specified', statusKind: 'live',
    ...
    handle: 'careshopapp',
    cta: { primary: 'Start the 3-day trial', secondary: 'See the buy queue', trial: true },
    tabs: ['Today', 'Stock', 'Buy', 'Menu', 'More'],
    nav: [{ group: 'The kitchen', items: ['Today', 'Stock', 'Buy queue', 'Shopping', 'Menu', 'Compliance'] }, { group: 'Organisation', items: ['Houses', 'Settings'] }],
    firstTen: ['Add a zone and scan five items from the pantry.', 'Set a par on one and watch it become a buy request.', 'Add a resident with a tree-nut allergy and see the menu warn.', 'Open Compliance and see the reserve target computed from the bed count.'],
    proof: ['Live at careshop.app and used by real houses; a caregiver scans groceries into it at the store today.', 'Every citation carries a confidence — confirmed or inferred — and an unreviewed rule set shows a banner on the dashboard and on every export.', 'Residents stay a label, never a name: diet tags, allergens, one texture level.'],
    doesNot: ['store diagnoses, medications, incidents or clinical notes (Cohort)', 'schedule anyone (Aidepost)', 'print the tab where a reserve record goes (Binderkit)', 'print a rule without its confidence, or certify compliance (never)'],
    pricing: { unit: 'house', rows: [['3-day trial', 'Card on file', 'Everything Pro shows; one-tap cancel'], ['Pro', '$19 / mo', 'Live price, carried as the anchor'], ['Scale', '$37 / mo', 'Unlimited houses and seats, branding, multi-house views']], note: 'Live prices carried as anchors; the rebuild keeps them.' },
  },
  {
    ...
    pricing: { unit: 'facility', rows: [['3-day trial', 'Card on file', 'Prints on day one'], ['Pro', 'Open (#9)', 'Or a single purchase — used twice a year'], ['Scale', 'Open (#9)', 'Multi-facility, the agency library, shared viewer seats']], note: 'Binderkit’s commercial shape is open item #9: subscription or single purchase.' },
  },
  {
    ...
    pricing: { unit: 'house + per post', rows: [['3-day trial', 'Card on file', 'Posting available on every tier, including the trial'], ['Pro', 'Open (#8)', 'Directory, credentials, roster, clock-in, timesheets'], ['Scale', 'Open (#8)', 'Unlimited houses; agency roles and CBTP items'], ['Job post', 'One charge per post', 'Publishes the listing when paid (D40)']], note: 'Caregivers pay nothing — a documented exception to the Family Standard’s signup.' },
  },
];
