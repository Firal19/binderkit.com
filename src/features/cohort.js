...
export const FEATURES = [
  ...
  { id: 'ch-15', name: 'The address — write, copy', kind: 'email',
    what: 'shift@cohorthome.app is a mailto everywhere it is printed, including inside the shift sheet, with a copy button that toasts.',
    probe: [{ home: 'mailto:shift@cohorthome.app' }, { home: 'data-copy="shift@cohorthome.app"' }, { home: 'class="copyb"' },
      { home: 'class="ssheet-f"' }, { home: 'mailto:shift@cohorthome.app?subject=' }] },
  ...
  { id: 'ch-36', name: 'The boundary, stated as refusals', kind: 'honesty',
    what: 'Five things Cohort will not do, listed plainly and without naming another product. Scheduling, the kitchen, binders, resident funds and policing compliance are each outside the record Cohort keeps, and the list says so rather than pointing somewhere.',
    probe: [{ home: 'class="bmap-l"' }, { home: 'Five things it will not do' }, { css: '.bmap-w::before' }] },
