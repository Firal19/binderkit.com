...
export const ICONS = {
  ...
  key: `<circle cx="8" cy="12" r="3.75"/><path d="M11.75 12h8.5M17.25 12v3M20.25 12v2.25"/>${dot(8, 12)}`,
  clipboard: `<rect x="5.25" y="4.75" width="13.5" height="16.5" rx="2"/><path d="M9.25 4.75V3.5h5.5v1.25M9 13l2.25 2.25L15.5 10.5"/>${dot(9, 13)}`,
  care: `<path d="M3.75 13.75c2.5 0 3.25 1.25 5.25 1.25h4.25a1.5 1.5 0 0 1 0 3h-3.5M12.25 18h5.75c1.1 0 2-.55 2.55-1.5l.7-1.25M3.75 20.5h2.5M15.4 10.25c-1.6-1.35-2.5-2.7-2.5-3.85a2 2 0 0 1 3.6-1.25 2 2 0 0 1 3.6 1.25c0 1.15-.9 2.5-2.5 3.85l-1.1.95z"/>${dot(6.75, 16.5)}`,
  spark: `<path d="M12 4.5v3M12 16.5v3M4.5 12h3M16.5 12h3M6.7 6.7l2.1 2.1M15.2 15.2l2.1 2.1M6.7 17.3l2.1-2.1M15.2 8.8l2.1-2.1"/>${dot(12, 12)}`,
  lock: `<rect x="5.25" y="10.5" width="13.5" height="10" rx="2"/><path d="M8.5 10.5V7.75a3.5 3.5 0 0 1 7 0v2.75"/>${dot(12, 15.5)}`,
