...
export const contactPage = { path: 'contact', title: 'Contact', description: 'Write to a person at plan@binderkit.com: one address, one inbox, one person reading. Tell us the facility code, never a resident’s name.', render };
