...
export const aboutPage = { path: 'about', title: 'About', description: 'Binderkit plans and prints binders for Oregon care homes. It holds nothing about any person. Made in Oregon by Providerhub Oregon.', render };
